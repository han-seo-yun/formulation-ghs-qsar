...
SRC_2ND = f"{INPUT_DIR}/dataset_2차배정_verified.xlsx"  # 260830에 미포함 — 이 스크립트는 참고용, 실행은 build_input_v3.py 사용
...
OUT_XLSX = f"{MODEL_DIR}/input_dataset_v2.xlsx"
OUTDIR = f"{MODEL_DIR}/v2"
