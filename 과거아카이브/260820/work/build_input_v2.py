...
BASE = "/Users/hanseoyun/Desktop/260820"
SRC_V1 = f"{BASE}/input_dataset.xlsx"
SRC_2ND = f"{BASE}/dataset_2차배정_verified.xlsx"
CIPAC_J = f"{BASE}/formulation_harness/cipac_codes.json"
TOXRUN = f"{BASE}/formulation_harness/_run_tox"
RESULTS = f"{BASE}/work/results"
OUT_XLSX = f"{BASE}/input_dataset_v2.xlsx"
OUTDIR = f"{BASE}/out/v2"
...
meta = [
    fillrow("버전", "input_dataset_v2", "2026-08-20 생성. input_dataset.xlsx + dataset_2차배정_verified.xlsx + Phase1 회수분"),
